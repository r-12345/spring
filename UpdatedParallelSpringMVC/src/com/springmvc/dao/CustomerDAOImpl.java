...
//DEPOSIT
	...
	public String deposit(String cmobno, double cbal) {
		...
		if(customer == null) {
		String msg = "You have entered incorrect mobile number. This mobile number is not associated with any account";
		return msg;
		}
...
//WITHDRAW
	...
	public String withdraw(String cmobno, double cbal) {
		Customer customer = em.find(Customer.class, cmobno);
		if(customer == null) {
		String msg = "You have entered incorrect mobile number.";
		return msg;
		}
...
//CHECK BALANCE
	...
	public String checkBalance(String cmobno) {
		...
		if(cust == null) {
		return "You have entered incorrect mobile number. This mobile number is not associated with any account.";
		}
	...
	public String trf(String cmobno, String rno, double cbal) {
		...
		if(customer == null) {
			String msg = "You have entered incorrect mobile number. This SENDER mobile number is not associated with any account.";
			return msg;
			}
